export type ConcreteQuestionKind = 'map' | 'name-to-map' | 'feature' | 'feature-to-name' | 'feature-to-flag' | 'flag-to-map' | 'map-to-flag'
export type QuestionKind = ConcreteQuestionKind | 'mix'

export const CONCRETE_QUESTION_KINDS: ConcreteQuestionKind[] = ['map', 'name-to-map', 'feature', 'feature-to-name', 'feature-to-flag', 'flag-to-map', 'map-to-flag']
...
export const QUESTION_META: Record<QuestionKind, {
  ...
  'name-to-map': { tab: '｜国名《こくめい》→｜場所《ばしょ》', homeLabel: '国名 → 場所', title: { main: 'この｜国《くに》の｜場所《ばしょ》は', accent: 'どこ？' }, lead: '｜表示《ひょうじ》された｜国名《こくめい》にあてはまる｜場所《ばしょ》', locationQuestion: true, highlightedCountry: false, usesFeature: false, answerType: 'location' },
